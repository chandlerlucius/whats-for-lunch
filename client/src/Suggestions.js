      ...
      this.props.locations && this.props.locations.map((location, index) =>
        <form key={index} action="vote" className="vote-form">
          <div>
            ...
            <h2 title="Click to add or remove up vote" onClick={this.submitForm} value="1" style={this.getArrowStyle(location, 1)}>
              ▲
            </h2>
            <div className="vote-container" style={this.getCountStyle(location)}>
              <h3 title={this.getTitle(location)}>{location.vote_count}</h3>
            </div>
            <h2 title="Click to add or remove down vote" onClick={this.submitForm} value="-1" style={this.getArrowStyle(location, -1)}>
              ▼
            </h2>
          </div>
          <div>
